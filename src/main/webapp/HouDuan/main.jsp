                    ...
                    <div class="panel-group" id="acc">
                                ...
                                <div class="panel-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <a id="user-btn" href="javascript:$('#centerLayout').load('${path}/HouDuan/user.jsp')" class="btn btn-default yx-nav-menu-btn">
                                                &nbsp;查看用户
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse" id="category-panel-body">
                                <div class="panel-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <a id="category-btn" href="javascript:$('#centerLayout').load('${path}/HouDuan/category.jsp')" class="btn btn-default yx-nav-menu-btn">
                                                &nbsp;分类
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse" id="video-panel-body">
                                <div class="panel-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <a id="video-btn" href="javascript:$('#centerLayout').load('${path}/HouDuan/video.jsp')" class="btn btn-default yx-nav-menu-btn">  &nbsp;视频管理 </a>
                                        </li><br>
                                        <li class="list-group-item">
                                            <a id="video-btn2" href="javascript:$('#centerLayout').load('${path}/HouDuan/searchVideo.jsp')" class="btn btn-default yx-nav-menu-btn">  &nbsp;视频检索 </a>
                                        </li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse" id="comment-panel-body">
                                <div class="panel-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <a href="javascript:$('#centerLayout').load('${path}/HouDuan/comment.jsp')" class="btn btn-default yx-nav-menu-btn">  &nbsp;查看评论 </a>
                                        </li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse" id="feedback-panel-body">
                                <div class="panel-body">
                                    <ul class="list-group">
                                        <a href="javascript:$('#centerLayout').load('${path}/HouDuan/Feedback.jsp')" class="btn btn-default yx-nav-menu-btn">  &nbsp;查看评论 </a>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-collapse collapse" id="log-panel-body">
                                <div class="panel-body">
                                    <a id="log-btn" href="javascript:$('#centerLayout').load('${path}/HouDuan/log.jsp')" class="btn btn-default yx-nav-menu-btn">  &nbsp;日志管理 </a>
